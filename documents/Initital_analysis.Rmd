...
# Load libraries ----------------------------------------------------------
# Package names
packages <- c("tidyverse", "here", "data.table", "igraph", "ggraph", "stringr", "tm", "tidytext", "pluralize" , "quanteda", "fst", "stopwords", "SnowballC", "textstem" ,"wordcloud2", "viridis", "htmlwidgets", "webshot", "lexicon", "wesanderson", "RColorBrewer", "textdata"
              )
...
mycolors <- c( rep('#00A6D6',6),rep('#000000',1000))
